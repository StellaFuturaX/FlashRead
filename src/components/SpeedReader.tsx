      ...
      >
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-4">
            <label className="text-sm font-medium text-gray-300 min-w-24">
              Speed: {wpm} WPM
            </label>
            <input
              type="range"
          ...
          <div className="flex justify-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-2 bg-blue-600 hover:bg-blue-500 rounded-lg transition-colors font-medium"
            >
          ...
          <p className="text-center text-xs text-gray-500">
            Press <kbd className="px-2 py-1 bg-gray-700 rounded">Space</kbd> to play/pause
          </p>
        </div>
      </div>
    </div>
