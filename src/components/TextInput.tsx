  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-6 space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-400">Master speed reading with RSVP technology</p>
      </div>

      <div className="bg-gray-800 rounded-xl p-6 space-y-4 border border-gray-700">
        <div className="flex items-center gap-2 text-gray-300 mb-2">
          <FileText size={20} />
          <h2 className="font-semibold">Input Your Text</h2>
        </div>
        ...
        <textarea
          ...
          className="w-full h-64 bg-gray-900 text-gray-100 rounded-lg p-4 border border-gray-700 focus:border-blue-500 focus:outline-none resize-none font-mono text-sm"
        />
        ...
        <div className="flex gap-3 flex-wrap">
          <button
            ...
            className="flex-1 min-w-32 px-6 py-3 bg-blue-600 hover:bg-blue-500 disabled:bg-gray-700 disabled:cursor-not-allowed rounded-lg transition-colors font-medium"
          >
            Start Reading
          </button>

          <label className="flex-1 min-w-32 px-6 py-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors font-medium cursor-pointer flex items-center justify-center gap-2">
            <Upload size={20} />
            Upload .txt
            <input
              type="file"
          ...
          <button
            ...
            className="flex-1 min-w-32 px-6 py-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors font-medium"
          >
            Load Sample
          </button>
        </div>
